...
.bgimg-1 {
  ...
  background-image: url("http://localhost:8089/HelpMyInterview/img/bear-connection-dark-461497.jpg");
  min-height: 100%;
}
...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card" id="myNavbar">
    ...
    <div class="w3-right w3-hide-small">
      ...
      <a href="signup.jsp" class="w3-bar-item w3-button"><i class="fa fa-usd"></i> SIGNUP</a>
...
<div class="w3-container" style="padding:128px 16px" id="team">
  ...
  <div class="w3-row-padding w3-grayscale" style="margin-top:64px">
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        <img src="http://localhost:8089/HelpMyInterview/img/taman.png" alt="Taman" height="350" style="width:100%;border-radius: 2%;" >
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        <img src="http://localhost:8089/HelpMyInterview/img/sourabh.jpg" alt="Sourabh" height="350" style="width:100%;border-radius: 2%">
        <div class="w3-container">
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        <img src="http://localhost:8089/HelpMyInterview/img/aditi.jpg" alt="Aditi" height="350" style="width:100%;border-radius: 2%">
        <div class="w3-container">
          <h3>Aditi Raj</h3>
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        <img src="http://localhost:8089/HelpMyInterview/img/ashi.png" alt="Ashi" height="350" style="width:100%;border-radius: 2%">
        <div class="w3-container">
          <h3>Ashi Gupta</h3>
          <p class="w3-opacity">Web Designer & Content-Manager</p>
          <p><button class="w3-button w3-light-grey w3-block"><i class="fa fa-envelope"></i> Contact</button></p>
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
      <img src="http://localhost:8089/HelpMyInterview/img/shailendra.jpg" alt="shailendra"  height="350" style="width:100%;border-radius: 2%">
        <div class="w3-container">
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        <img src="http://localhost:8089/HelpMyInterview/img/none.png" alt="Gaurav"  height="350" style="width:100%;border-radius: 2%">
        <div class="w3-container">
          <h3>Gaurav Jha</h3>
